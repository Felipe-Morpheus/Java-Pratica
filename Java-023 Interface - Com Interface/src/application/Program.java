...
public class Program {
	...
	public static void main(String[] args) {
		...
		System.out.println("Pagamento básico: " + String.format("%.2f", cr.getInvoice().getBasicaPayment()));
		System.out.println("Imposto: " + String.format("%.2f", cr.getInvoice().getTax()));
		System.err.println("Pagamento total: " + String.format("%.2f", cr.getInvoice().getTotalPayment()));
